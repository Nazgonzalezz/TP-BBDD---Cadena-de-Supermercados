...
begin
    ...
    -- insertar los registros desde la tabla temporal a sucursales.empleado
    ...
    inner join sucursales.sucursal as s on s.localidad = temp.sucursal; -- DEBEN ESTAR CARGADAS LAS SUCURSALES
